...
{   
    ...
    public class MoviesController : BootstrapBaseController
    {
        ...
        {
            var movies = _movieRepository.Get().Where(m => m.Title.Contains(searchText));
            return PartialView(movies);
        }

        public PartialViewResult AddRating(int movieId)
        {
            var rating = new Rating { MovieId = movieId };
            return PartialView();
        }
